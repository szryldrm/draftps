...
namespace DraftPS.WebUI.Controllers
{
    public class CountriesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ID,Name,DateTime,IsDeleted")] Country country)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ID,Name,DateTime,IsDeleted")] Country country)
        {
            if (ModelState.IsValid)
            {
